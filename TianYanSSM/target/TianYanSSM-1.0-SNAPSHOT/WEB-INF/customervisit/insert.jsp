...
<body>
    ...
    <br/>
    <br/>
    <form class="form-horizontal" role="form" action="doCustomervisitInsert" method="post">
        <div class="form-group">
            <label for="empname" class="col-sm-2 control-label">员工姓名:</label>
            <div class="col-sm-5">
                <input type="text" disabled="disabled" class="form-control" name="empname" id="empname" value="<shiro:principal/>" >
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="content" id="content" placeholder="请输入谈话内容" onblur="checkContent(this)">
            </div>
        </div>
        <div class="form-group">
            <label for="date" class="col-sm-2 control-label">谈话日期:</label>
            <div class="col-sm-5">
                <input type="text" class="form-control Wdate" name="date" id="date" placeholder="请输入谈话日期" onclick="WdatePicker()" onblur="checkDate(this)">
            </div>
        </div>
        <div class="form-group">
